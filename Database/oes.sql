...
('APTITUDE',	'00:30:00',	33,	'2018-03-23 06:05:02',	0,	9,	2),
('COMPUTER',	'00:45:00',	34,	'2018-03-22 17:18:03',	0,	6,	0),
('MATHS',	'00:30:00',	32,	'2018-01-30 14:25:19',	1,	8,	4);
...
('Ap1',	'what is 3% of 5% ?',	'60%',	'30%',	'15%',	'45%',	2,	'APTITUDE'),
('AP2',	'In how many ways the letter ‘SOLVING’ can be\nrearranged to make 7 letter words such that none\nof the letters repeat?',	'49',	'5040',	'7670',	'None of the above',	2,	'APTITUDE'),
('AP3',	'What is the missing letter in this series?\n  b e h k n ? t',	'q',	'r',	's',	'u',	2,	'APTITUDE'),
('AP4',	'The average age of a group of 5 students was 10.The \naverage age increased by 4 years when 2 new \nstudents joined the group.What is the average age of \nthe two new students who joined the group?',	'15',	'20',	'22',	'24',	4,	'APTITUDE'),
('AP5',	'If you unscramble the letters YKANE, you will get the \nname of a:',	'Mountain Pass',	'Warrior',	'Flower',	'Country',	4,	'APTITUDE'),
('AP6',	'3 is 80% of what number?',	'2.50',	'3.00',	'3.75',	'3.50',	3,	'APTITUDE'),
('AP7',	'In an equation, (96)^(1/2) ÷ (k)^(1/2) = 2*(6)^(1/2);\nwhat value of k will satisfy the equation?',	'2',	'4',	'6',	'8',	2,	'APTITUDE'),
('AP8',	'To the correct number of significant figures, \n(5.0 x 10^-5) ÷ (2.00 x 10^-2) is?',	'2.5X10^-7',	'2.5X10^-3',	'2.50X10^-3',	'None of the above',	2,	'APTITUDE'),
('AP9',	'The product of 3×2 matrix and 2×3 matrix will result \nin what order matrix?',	'3x2',	'2x2',	'2x3',	'3x3',	4,	'APTITUDE'),
